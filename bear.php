...
<body>
    <h1 class="Bienvenida">Bienvenido <?php echo $user?></h1>
    <a class="Logout" href="logout.php">Logout</a>

    
    <a class="BotonClientes" href="Clientes.php">Clientes</a>
    <a class="BotonMascotas" href="Mascotas.php">Mascotas</a>
    <a class="BotonCitas" href="Citas.php">Citas</a>
                ...
                <g id="bear">
                    ...
                    <g id="body">
                        ...
                        <path
                            ...
                            fill="#af571d" />
                        <path d="M165.7,533.3c39.9,27.3,80.5,27.7,120,0" fill="none" stroke="#3f1c0d"
                            stroke-linecap="round" stroke-miterlimit="10" stroke-width="10" />
                    </g>
                    <g id="Head" class="head">
                        <g id="ears" class="ears">
                            <g>
                                <circle cx="92.2" cy="53.9" r="48.9" fill="#e07320" stroke="#3f1c0d"
                                    stroke-miterlimit="10" stroke-width="10" />
                                <circle cx="93.1" cy="53.9" r="31.9" fill="#ee9e5c" />
                            </g>
                            <g>
                                <circle cx="351.6" cy="53.9" r="48.9" fill="#e07320" stroke="#3f1c0d"
                                    stroke-miterlimit="10" stroke-width="10" />
